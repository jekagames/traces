...
//SOME MORE FIRMATA CODE OMG SO COMPLICATED JUST TO GET THIS WORKING
/* analog inputs */
...
unsigned int i2cReadDelayTime = 1000;
...
void setup() {
  ...
  //disableI2CPins();//firmata-specific code, trying to free the pins for nfc
  nfc.begin();
  ...
  //MORE SETUP-SPECIFIC FIRMATA CODE
...
//  //END OF FIRMATA-SPECIFIC SETUP CODE
}
